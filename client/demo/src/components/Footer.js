      ...
      <div className="row">
        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
          <div className="footer_widget">
            <img src="http://konsultsoft.com/images/logo.png" className="img-footer small mb-2" alt />
    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-lg-12 col-md-12 text-center">
          <p className="mb-0">© 2022 KonsultSoft. Designd By <a href="https://themezhub.com">ThemezHub</a>.</p>
        </div>
      </div>
    </div>
  </div>
